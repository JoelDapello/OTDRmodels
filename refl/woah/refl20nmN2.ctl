...
(define-param sy 4) ; size of cell in Y direction in um
(set! geometry-lattice (make lattice (size sx sy no-size)))

;; make objects
(set! geometry (list
                ;; waveguide 
                (make block (center -15 0.24 ) (size 70 0.01 infinity)
                      (material (make dielectric (epsilon 11.68))))
                ;; waveguide 
                (make block (center 30 0.24 ) (size 20 0.02 infinity)
                      (material (make dielectric (epsilon 2))))
                ;; waveguide 
                (make block (center 45 0.24 ) (size 10 0.01 infinity)
                      (material (make dielectric (epsilon 11.68))))
                ;; waveguide
                ...
                (make block (center -15 -0.24 ) (size 70 0.02 infinity)
                      (material (make dielectric (epsilon 11.68))))
                ;; waveguide 
                (make block (center 30 -0.24 ) (size 20 0.01 infinity)
                      (material (make dielectric (epsilon 2))))
                ;; waveguide 
                (make block (center 45 -0.24 ) (size 10 0.01 infinity)
                      (material (make dielectric (epsilon 11.68))))
