...
(set! geometry (list
                ;; nanosheet capacitor
                (make block (center 0 1.275 ) (size 650 2 infinity)
                      (material (make dielectric (epsilon 9))))
                ;; nanosheet capacitor
                (make block (center 0 0.275 ) (size 650 0.05 infinity)
                ...
                (make block (center 0 -1 ) (size 650 1.5 infinity)
                      (material (make dielectric (epsilon 9.0))))
                ;; platinum
                (make block (center 0 -2.25 ) (size 650 1 infinity)
                      (material myPt))
                ))
